          ...
          <div className="dropdown-menu information-grid">
            <div>
              ...
              <div className="dropdown-links">
                <Link to="/store">
                  <div className="link">Chairs</div>
                </Link>
                <Link to="/store">
                  <div className="link">Sofas</div>
                </Link>
                <Link to="/store">
                  <div className="link">Stools</div>
                </Link>
              </div>
            </div>
            <div>
              ...
              <div className="dropdown-links">
                <Link to="/store">
                  <div className="link">Refrigerators</div>
                </Link>
                <Link to="/store">
                  <div className="link">Ovens</div>
                </Link>
                <Link to="/store">
                  <div className="link">Washing Mashines</div>
                </Link>
              </div>
            </div>
            <div>
              ...
              <div className="dropdown-links">
                <Link to="/store">
                  <div className="link">Desks</div>
                </Link>
                <Link to="/store">
                  <div className="link">Dining Tables</div>
                </Link>
              </div>
            </div>
            <div>
